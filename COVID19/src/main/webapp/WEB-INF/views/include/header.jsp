...
<header id = "header">
	<nav id = "gnb">
		<ul class = "gnbList">
			<li>
				<a href="" class = "depth01">COVID19 정보</a>
				<ul class = "depth02">
			...
			<li>
				<a href="" class = "depth01">백신 접종 예약</a>
				<ul class = "depth02">
			...
			<li>
				<a href="" class = "depth01">백신 접종 예약현황</a>
				<ul class = "depth02">
