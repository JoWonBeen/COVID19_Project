...
<link rel="stylesheet" href="css/mediSearch.css">
<script src="js/mediCenter.js" defer></script>
</head>
<body>
	<div id="mediCenter">
		<header id="mediCenterHeader" class="mediCenterHeader">
			<h1>
		...
		<main id="main">
				<select>
					...
					<option value="예방접종센터">예방접종센터</option>
				...
				<div class="btns">
					<button type="submit" id="mediCenterSearch">의료기관 찾기</button>
				</div>
